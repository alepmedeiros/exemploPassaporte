...
//    FConnList.Items[IndexConn].Params.UserName := 'username';
//    FConnList.Items[IndexConn].Params.Password := 'senha';
//    FConnList.Items[IndexConn].Params.Add('Port=xxxx');
//    FConnList.Items[IndexConn].Params.Add('Server=xxxxx');
